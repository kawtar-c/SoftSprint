...
<head>
  <meta charset="UTF-8" />
  <title>Prenota un tavolo - Ristorante Softsprint</title>
...
<div class="form-group">
  ...
  <div class="form-group">
    ...
    <textarea id="note" name="note" rows="3"
      placeholder="Es. intolleranze, richiesta seggiolone, compleanno..."></textarea>
  </div>

  <div class="order-actions booking-actions">
    <button type="submit" class="btn-primary" id="btn-prenota">
