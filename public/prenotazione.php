...
<section id="prenotazione" class="booking-section">
    <div class="container">
        ...
        <div class="booking-grid"
            ...
            <div class="order-panel" style="flex:1 1 0;">
                ...
                <form id="booking-form" class="booking-form" action="#" method="POST">
                    ...
                    <div class="order-actions booking-actions">
                        <button name="booking-form" type="submit" class="btn-primary" id="btn-prenota">
            ...
            <aside class="order-panel booking-slots" style="flex:1 1 0;">
